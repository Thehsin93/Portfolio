...
const ViewPage = () => {
  ...
  return (
    <div className='w-100% flex md:flex-row flex-col h-screen'>
   {watchid=="vcwsBgrUIS4" &&<FoodComponent/>}
   {watchid=="zf6M6pR9QA8" &&<NetflixComponent/>}
   {watchid=="e5R91k4EEAA" &&<YoutubeComponent/>}
    <div className='w-[100%] md:w-[55%] items-center shadow-lg bg-gray-300 rounded-lg'>
    <iframe className="w-[100%] md:h-screen h-[100%] rounded-2xl"
