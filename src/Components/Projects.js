...
const Projects = () => {
  return (
    <div className='w-screen'>
        ...
        <div  className="m-4 p-4 w-[20%]  rounded-2xl bg-gray-100 hover:bg-gray-200 text-left cursor-pointer">
        <Link to={"/ViewProj/vcwsBgrUIS4"}>
        <ImageFood/>
       
        <h3 className="text-wrap font-bold underline">Food Ordering APP</h3>
        <h4 className="overflow-hidden whitespace-normal">A food delivery app designed for demo</h4>
        <h4>https://main--foodorderingcj.netlify.app/</h4>
        </Link>
        </div>
       
      
        <div  className="m-4 p-4 w-[20%] rounded-2xl bg-gray-100 hover:bg-gray-200 cursor-pointer">
       ...
       <ImageNetflix/>
        ...
        <h4>https://main--netflixgptcj.netlify.app/</h4>
        </Link>
        </div>
      ...
      <ImageYoutube/>
        ...
        <h4>https://myreactyoutube.netlify.app</h4>
        </Link>
        </div>
